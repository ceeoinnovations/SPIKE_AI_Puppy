...
#This code creates a puppy training class where the puppy:
    ...
    #"forgots" the training if prompted
...
class PuppyTraining:
    ...
    def __init__(self):
        # Constructor 
        self.dist_sensor = hub.port.C.device   ######## <----------- REPLACE with the hub port of your ultrasonic sensor #########
    ...
    def watch(self):
        ...
        while not hub.button.center.is_pressed() and command != "Exit":
